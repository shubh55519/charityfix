              ...
              <div class="col-xxl-6 col-xl-6 col-lg-6">
                <div class="d-flex gap-44">
                  <div class="hero-image position-relative d-none d-lg-block">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/hero/hero-1.png" alt="img" class="w-100 tilt-effect wow fadeInUp" data-wow-delay="0.1s">
                  </div>
      ...
      <section class="helpful-area">
        <div class="container">
         <!-- <?php foreach($cat as $catValue  ){?>
           <h3><?php echo $catValue->name?></h3> 
          <?php }?>   -->
          <?php 
          $artCat = get_terms(['taxonomy'=>'article_category', 'hide_empty'=>false]);
          // print_r($artCat);
          echo 'String';
          foreach($artCat as $artCatValue){
          ?>
          <div class="row gy-24">
          ...
          <div class="row justify-content-center">
            <div class="col-xxl-7 col-xl-8 col-lg-8 p-0 urgent-area-slide xs-p-12">
              ...
              <div class="image-container position-relative h-100">
                <img class="w-100 h-100" src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/urgent-1.png" alt="img">
      ...
      <section class="question-area bottom-padding">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-5">
              <img class="w-100 d-none d-lg-block tilt-effect" src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/que.png" alt="image">
            </div>
          </div>
        </div>
      </section>
          ...
          <div class="row gy-24">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-event h-calc wow fadeInUp" data-wow-delay="0.0s">
                <div class="event-img position-relative">
                  <a href="event-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/event-2.png" class="img-fluid w-100" alt="img"> </a>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-event h-calc wow fadeInUp" data-wow-delay="0.1s">
                <div class="event-img position-relative">
                  <a href="event-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/event-3.png" class="img-fluid w-100" alt="img"> </a>
                </div>
                <div class="event-info">
                  <div class="d-flex justify-content-between align-items-center gap-6">
                    <div class="event-info-title">
          ...
          <div class="row gy-24">
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-1.png" class="img-fluid w-100" alt="img"> </a>
                </div>
                  <div class="blog-info">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc wow fadeInUp" data-wow-delay="0.0s">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-2.png" class="img-fluid w-100" alt="img"> </a>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-3.png" class="img-fluid w-100" alt="img"> </a>
                </div>
                  <div class="blog-info">
                    <div class="blog-info-title">
                      <div class="flex gap-16 align-items-center">
