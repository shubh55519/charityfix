        ...
        <div class="container">
          <div class="row gy-24">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-8.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-9.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img">
                  <a href="blog-details.html">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-10.png" class="img-fluid w-100" alt="img">
                  </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-11.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-12.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img">
                  <a href="blog-details.html">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-13.png" class="img-fluid w-100" alt="img">
                  </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-14.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 view-wrapper">
              <div class="single-blog h-calc">
                <div class="blog-img position-relative">
                  <a href="blog-details.html"> <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/blog-15.png" class="img-fluid w-100" alt="img"> </a>
                  <div class="brush-bg">
                    <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/brush.png" alt="image">
                  </div>
                </div>
