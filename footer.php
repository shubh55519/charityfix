<footer>
            ...
            <div class="col-lg-12">
              <div class="menu-wrapper d-flex align-items-center justify-content-between">
                <div class="header-left d-flex align-items-center justify-content-between">
                  <!-- Logo-->
                  <div class="logo">
                    <a href="index.html"><img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/logo/dark.png" alt="logo"></a>
                  </div>
                </div>
                <!-- Footer-menu -->
                ...
                <ul class="imp-link">
                    ...
                    <div class="d-flex gap-20 mb-20 align-items-center">
                      <div class="project-img">
                        <a href="donation-details.html">
                          <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/project-1.png" alt="image">
                        </a>
                      </div>
                  ...
                  <li class="single-list">
                    <div class="d-flex gap-20">
                      <div class="project-img">
                        <a href="donation-details.html">
                          <img src="<?php echo get_template_directory_uri();  ?>/theme/assets/images/gallery/project-2.png" alt="image">
                        </a>
                      </div>
                      <div class="project-info">
    ...
    <!-- jquery-->
    <script src="<?php echo get_template_directory_uri();  ?>/theme/assets/js/jquery-3.7.0.min.js"></script>
    <script src="<?php echo get_template_directory_uri();  ?>/theme/assets/js/popper.min.js"></script>
    <script src="<?php echo get_template_directory_uri();  ?>/theme/assets/js/bootstrap-5.3.0.min.js"></script>
    <!-- Plugin -->
    <script src="<?php echo get_template_directory_uri();  ?>/theme/assets/js/plugin.js"></script>
    <!-- Main js-->
    <script src="<?php echo get_template_directory_uri();  ?>/theme/assets/js/main.js"></script>
  </body>
